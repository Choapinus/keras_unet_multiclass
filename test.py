...
def image_normalized(file_path):
	...
	img_standard = cv2.resize(img, image_size, interpolation=cv2.INTER_CUBIC)
...
if __name__ == '__main__':
	...
	save_path = "640x400_small/predict"

	dp = data_preprocess(test_path=test_path,save_path=save_path,flag_multi_class=True,num_classes=4)

	#load model
	model = load_model('./model/Opends_model_v1.hdf5')
